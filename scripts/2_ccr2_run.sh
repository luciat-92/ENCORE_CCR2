...
# sbatch --array=1-32%11 scripts/2_ccr2_run.sh ORIGINAL c91
# sbatch --array=1-32%11 scripts/2_ccr2_run.sh ORIGINAL c92
# sbatch --array=1-32%11 scripts/2_ccr2_run.sh ORIGINAL cavg
# sbatch --array=1-32%11 scripts/2_ccr2_run.sh BATCH_CORRECTED c91
# sbatch --array=1-32%11 scripts/2_ccr2_run.sh BATCH_CORRECTED c92
# sbatch --array=1-32%11 scripts/2_ccr2_run.sh BATCH_CORRECTED cavg
